<?php
/* Smarty version 3.1.30, created on 2017-11-25 10:48:50
  from "/home/bantenbersatu/public_html/serang/application/views/main_templates/layout.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5a18e822406592_01561339',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'ded31c240dc0e467a41a9133ce0c593ad1340a10' => 
    array (
      0 => '/home/bantenbersatu/public_html/serang/application/views/main_templates/layout.html',
      1 => 1511581707,
      2 => 'file',
    ),
  ),
...
function content_5a18e822406592_01561339 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
<head>
...
?>
  ...
  <!--[if lt IE 9]>
  <?php echo '<script'; ?>
 type="text/javascript" src="https://oss.maxcdn.com/html5shiv/3.7.3/html5shiv.min.js"><?php echo '</script'; ?>
>
  <?php echo '<script'; ?>
...
>
  <![endif]-->
  <?php echo '<script'; ?>
 type="text/javascript" src="https://cdn.onesignal.com/sdks/OneSignalSDK.js" async='async'><?php echo '</script'; ?>
>
  <?php echo '<script'; ?>
>
...
tps"><i class="fa fa-circle-o"></i> List TPS</a></li>
        ...
        <li class="<?php if (isset($_smarty_tpl->tpl_vars['qc_menu']->value)) {?>active<?php }?> treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url();?>
count/index/add"><i class="fa fa-circle-o"></i>Add Quick Count</a></li>
            <li><a href="<?php echo base_url();?>
count"><i class="fa fa-circle-o"></i> List Quick Count</a></li>
          </ul>
        </li>
...
<!-- Morris.js charts -->
<!--<?php echo '<script'; ?>
 type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/raphael/2.1.0/raphael-min.js"><?php echo '</script'; ?>
>-->
<!--<?php echo '<script'; ?>
 type="text/javascript" src="<?php echo assets_url();?>
...
<!-- daterangepicker -->
<?php echo '<script'; ?>
 type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.11.2/moment.min.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 type="text/javascript" src="<?php echo assets_url();?>
