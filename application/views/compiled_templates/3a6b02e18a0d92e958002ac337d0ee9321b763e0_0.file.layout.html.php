<?php
/* Smarty version 3.1.30, created on 2016-10-27 19:56:22
  from "E:\Xampp\htdocs\sipongan-backend\application\views\main_templates\layout.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5811f9764d5e06_75114215',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '3a6b02e18a0d92e958002ac337d0ee9321b763e0' => 
    array (
      0 => 'E:\\Xampp\\htdocs\\sipongan-backend\\application\\views\\main_templates\\layout.html',
      1 => 1477572977,
      2 => 'file',
    ),
  ),
...
function content_5811f9764d5e06_75114215 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
<head>
...
" class="logo">
      ...
      <span class="logo-lg"><b>Sipongan</b>Nganjuk</span>
    </a>
...
dashboard">
        ...
        <li class="<?php if (isset($_smarty_tpl->tpl_vars['places_menu']->value)) {?>active<?php }?> treeview">
          <a href="#">
            ...
            <?php if ($_smarty_tpl->tpl_vars['j_place_new']->value > 0) {?><span class="label bg-red pull-right-container"><?php echo $_smarty_tpl->tpl_vars['j_place_new']->value;?>
</span><?php }?>
          </a>
...
places"><i class="fa fa-circle-o"></i> List Place</a></li>
        ...
        <li class="<?php if (isset($_smarty_tpl->tpl_vars['users_menu']->value)) {?>active<?php }?> treeview">
          <a href="#">
            ...
            <?php if ($_smarty_tpl->tpl_vars['j_user_new']->value > 0) {?><span class="label bg-red pull-right-container"><?php echo $_smarty_tpl->tpl_vars['j_user_new']->value;?>
</span><?php }?>
          </a>
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url();?>
...
users"><i class="fa fa-circle-o"></i> List Users</a></li>
        ...
        <li class="<?php if (isset($_smarty_tpl->tpl_vars['message_menu']->value)) {?>active<?php }?> treeview">
          <a href="#">
            ...
            <?php if ($_smarty_tpl->tpl_vars['j_message_new']->value > 0) {?><span class="label bg-red pull-right-container"><?php echo $_smarty_tpl->tpl_vars['j_message_new']->value;?>
</span><?php }?>
          </a>
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url();?>
...
qresponses">
            ...
            <?php if ($_smarty_tpl->tpl_vars['j_qresponse_new']->value > 0) {?><span class="label bg-red pull-right-container"><?php echo $_smarty_tpl->tpl_vars['j_qresponse_new']->value;?>
</span><?php }?>
          </a>
        </li>
...
reports">
            ...
            <?php if ($_smarty_tpl->tpl_vars['j_report_new']->value > 0) {?><span class="label bg-red pull-right-container"><?php echo $_smarty_tpl->tpl_vars['j_report_new']->value;?>
</span><?php }?>
          </a>
        </li>
        <li class="<?php if (isset($_smarty_tpl->tpl_vars['services_menu']->value)) {?>active<?php }?> treeview">
          <a href="#">
            ...
            <?php if ($_smarty_tpl->tpl_vars['j_service_new']->value > 0) {?><span class="label bg-red pull-right-container"><?php echo $_smarty_tpl->tpl_vars['j_service_new']->value;?>
</span><?php }?>
          </a>
          <ul class="treeview-menu">
            <li>
...
cctv">
            ...
            <span>CCTV</span>
            <?php if ($_smarty_tpl->tpl_vars['j_cctv_new']->value > 0) {?><span class="label bg-red pull-right-container labelalert"><?php echo $_smarty_tpl->tpl_vars['j_cctv_new']->value;?>
</span><?php }?>
          </a>
        </li>
